...
```sh
$ timestamp=$(echo "2019-12-19 22:06:09" /home/saverio/Desktop/test_abc.png | awk '{print $1 " " $2 }') # 2019-12-19 22:06:09
...
```sh
$ echo "2019-12-19 22:06:09" /home/saverio/Desktop/test_abc.png | perl -lane 'print "@F[2..$#F]"'
/home/saverio/Desktop/test_abc.png
```
...
```sh
$ echo "2019-12-19 22:06:09" /home/saverio/Desktop/test_abc.png | cut -d ' ' -f 3-
/home/saverio/Desktop/test_abc.png
```
...
```sh
$ echo "2019-12-19 22:06:09" /home/saverio/Desktop/test_abc.png | cut -c 21-
/home/saverio/Desktop/test_abc.png
```
